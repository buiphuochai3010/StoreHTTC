...
const handleSubmit = async () => {
    const data = {
        username: document.querySelector('input[name="username"]') as HTMLInputElement,
        ...
        repeat_password: document.querySelector('input[name="repeat-password"]') as HTMLInputElement
    };
    ...
    if (typeof signUpResponse.error !== "undefined") {
        console.log('Sign Up error:', signUpResponse.error);
    } else {
        console.log('Sign Up success:', signUpResponse);
        Router.push('http://localhost:3000/account/SignIn');
    }
}
                                ...
                                <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John"/>
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-5">
                                            ...
                                            <div className="flex">
                                                ...
                                                <input type="email" name="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="abc@example.com" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex -mx-3">
                                    ...
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-12">
                                            <label htmlFor="" className="text-xs font-semibold px-1">Repeat Password:</label>
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                                                </svg></div>
                                                <input type="password" name="repeat-password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex -mx-3 flex-row-reverse">
